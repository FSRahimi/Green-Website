  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-24">
      <div className="max-w-3xl">
        ...
        <h2 className="mt-5 text-5xl font-black leading-tight tracking-tight sm:text-6xl text-white">
          Building cleaner communities, one project at a time.
        </h2>
      </div>

      <div className="mt-10 grid gap-8 text-xl leading-9 text-white/80 md:grid-cols-2">
        <p>{province.about}</p>
        <p>
