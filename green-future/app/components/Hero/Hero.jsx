      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 py-24">
        <div className="grid w-full items-center gap-16 lg:grid-cols-[1fr_340px]">
          ...
          <aside className="hidden lg:flex justify-end">
            <div
              className="group relative w-80 overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-8 backdrop-blur-2xl
               shadow-2xl transition-all duration-500 ease-out hover:-translate-y-4 hover:scale-[1.03] hover:border-green-400/40 hover:shadow-[0_35px_80px_rgba(34,197,94,0.18)]"
            >
